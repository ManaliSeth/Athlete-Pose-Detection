...
if MODE is "COCO":
    protoFile = "C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/coco/pose_deploy_linevec.prototxt"
    weightsFile = "C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/coco/pose_iter_440000.caffemodel"
    nPoints = 18
    POSE_PAIRS = [[1, 0], [1, 2], [1, 5], [2, 3], [3, 4], [5, 6], [6, 7], [1, 8], [8, 9], [9, 10], [1, 11],
                  [11, 12], [12, 13], [0, 14], [0, 15], [14, 16], [15, 17]]

elif MODE is "MPI":
    protoFile = r"C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/mpi/pose_deploy_linevec.prototxt"
    weightsFile = r"C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/mpi/pose_iter_160000.caffemodel"
    nPoints = 15
    POSE_PAIRS = [[0, 1], [1, 2], [2, 3], [3, 4], [1, 5], [5, 6], [6, 7], [1, 14], [14, 8], [8, 9], [9, 10],
                  [14, 11], [11, 12], [12, 13]]

userImageInput = cv2.VideoCapture(r"C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/Video_Pose/inputVideo/input_1.mp4")
frame_width = int(userImageInput.get(3))
frame_height = int(userImageInput.get(4))
fps = int(userImageInput.get(5))

img = r"C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/White.jpg"
...
out = cv2.VideoWriter(r'C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/Video_Pose/outputVideo/1.mp4', fourcc, 30, (frameWidth1, frameHeight1))
out1 = cv2.VideoWriter(r'C:/Users/DELL/PycharmProjects/project/Video_Image_Pose/Video_Pose/outputVideo/2.mp4', fourcc, fps, (frame_width, frame_height))
threshold = 0.1
